...
plot_stop_date <- as.Date( "2020-12-30")
today <- Sys.Date()

changepoint1  <- as.Date("2020-08-25")
changepoint2  <- as.Date("2020-09-17")
textpoint <- as.Date("2020-11-20") 
...
p1 <- ggplot(data = dat) +
  ...
  geom_rect(xmin = as.Date("2020-10-20"), xmax = Inf, ymin = -Inf, ymax = Inf, fill = "grey", alpha = 0.01) +
