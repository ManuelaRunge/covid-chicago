...
modelVars <- c("time", "startdate", "scen_num", "sample_num", "run_num")
interventionVars <- c("time_to_detection", "detection_success", "isolation_success")
...
getdata <- function(selected_ems) {
  ...
  groupvars <- c(modelVars, interventionVars)
