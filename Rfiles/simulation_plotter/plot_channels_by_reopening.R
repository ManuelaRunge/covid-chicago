...
exp_name <- "20201110_IL_baseline_gradual_reopening"  #"20200917_IL_gradual_reopening
simdate <- strsplit(exp_name, "_")[1]
simtoday <- as.Date("2020-10-02")  # as.Date("2020-09-20"), as.Date("2020-10-20")
stopdate <- as.Date("2021-01-01") #as.Date("2021-01-01")  # as.Date("2020-09-20")
