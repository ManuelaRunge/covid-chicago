...
if (methodPlot) {
  ...
  selected_ems <- c(1:11)
  emsvars_temp <- c("crit_det_EMS.")   ### c("critical_EMS.")
  emsvars <- NULL
  ...
  trajectoriesDat <- read_csv(file.path(simulation_output, "contact_tracing",simdate, exp_name, "trajectoriesDat_trim.csv"), 
                              col_types = cols_only(time = col_guess(), 
                                                    ...
                                                    `crit_det_EMS-1` = col_guess() ,
                                                    `critical_EMS-2` = col_guess(),
                                                    `crit_det_EMS-2` = col_guess() ,
                                                    `critical_EMS-3` = col_guess(),
                                                    `crit_det_EMS-3` = col_guess() ,
                                                    `critical_EMS-4` = col_guess(),
                                                    `crit_det_EMS-4` = col_guess() ,
                                                    `critical_EMS-5` = col_guess(),
                                                    `crit_det_EMS-5` = col_guess() ,
                                                    `critical_EMS-6` = col_guess(),
                                                    `crit_det_EMS-6` = col_guess() ,
                                                    `critical_EMS-7` = col_guess(),
                                                    `crit_det_EMS-7` = col_guess() ,
                                                    `critical_EMS-8` = col_guess(),
                                                    `crit_det_EMS-8` = col_guess() ,
                                                    `critical_EMS-9` = col_guess(),
                                                    `crit_det_EMS-9` = col_guess() ,
                                                    `critical_EMS-10` = col_guess(),
                                                    `crit_det_EMS-10` = col_guess() ,
                                                    `critical_EMS-11` = col_guess(),
                                                    `crit_det_EMS-11` = col_guess() 
                              )) %>%
