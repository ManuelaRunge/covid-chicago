#!/bin/bash
#SBATCH --job-name="loessheatmap"       # Name of job
...
#SBATCH --output=/home/mrm9534/jobs/outputs/get_Rt2-%A_%a.out    # Path for output must already exist
#SBATCH --error=/home/mrm9534/jobs/errors/get_Rt2-%A_%a.err      # Path for errors must already exist
#SBATCH --array=1-11
...
R --vanilla -f "/home/mrm9534/gitrepos/covid-chicago/Rfiles/ct_analysis/heatmap_loess_contactTracing.R" ""${SLURM_ARRAY_TASK_ID}""
