...
first_plot_day = pd.to_datetime( date(2020, 3, 15))
...
def plot_covidregions(exp_name,channel,ageGroup_list,ageGroups, perPop=True) :
    ...
    for p, exp_name in enumerate(exp_names) :
        ...
        if perPop == True :
            ...
            ytitle = "Infected per population"
        ...
        for c, grp_channel in enumerate(channels_new) :
            ...
            ax.plot(mdf['date'], mdf['CI_50'], color=palette[c], label=grp_label)
            ...
            ax.set_title(exp_name_label, y=0.85)
...
if __name__ == '__main__' :
    ...
    exp_names = ['20201021_EMS_1_testrun_ct_2ndWave','20201016_EMS_1_mr_testrun2_ct_2ndWave']
