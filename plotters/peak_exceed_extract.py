...
def get_time_since_trigger(df=None):
...
if __name__ == '__main__':
    ...
    sim_output_dir = os.path.join('C:/Users/mrm9534/Box/NU-malaria-team/projects/covid_chicago/cms_sim/simulation_output/_overflow_simulations/20201121')
