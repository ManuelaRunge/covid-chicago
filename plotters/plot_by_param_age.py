...
def plot_covidregions(exp_names,channel,subgroups, psuffix) :
    ...
    for c, age_suffix in enumerate(subgroups) :
        ...
        for d, exp_name in enumerate(exp_names) :
            ...
            exp_name_label = exp_name # int(exp_name.split('_')[0])
...
if __name__ == '__main__' :
    ...
    exp_names = ['20201009_EMS_11_ms_age_cdc_v1','20201009_EMS_11_ms_age_cdc_v2']
    ...
    plot_covidregions(exp_names,channel='infected', subgroups = ageGroup_list,  psuffix ='_MarchOct')
